...
```{r}
num_pred_days <- 2
# Assuming num_components, num_pred_days, and the data frame y are already defined
# Also assuming optim_parm and kf.gp are predefined functions
...
# Step 1: Aggregate over columns
column_sums = apply(time_series_df, MARGIN = 2, FUN = sum)
...
QP_result <- solve.QP(2*covar_mat, unname(column_sums), matrix(1, nrow=num_components,ncol=1), c(1), meq=1)
QP_result$solution
```
